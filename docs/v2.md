...
通过观察可以看到这个数据的设置符合`com.github.huifer.entity.plugin.example.impl.OauthUserEntityConvert#fromInsType` 的处理
...
通过观察可以发现符合`com.github.huifer.entity.plugin.example.impl.OauthUserEntityConvert#fromEntity`处理过程
...
可以发现它符合`com.github.huifer.entity.plugin.example.impl.OauthUserEntityConvert#fromUpType`的处理过程。
...
可以发现此时符合`com.github.huifer.entity.plugin.example.impl.OauthUserEntityConvertInSpring#fromInsType`代码的处理。
